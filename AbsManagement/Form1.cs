...
namespace projetabc
{
    public partial class Form1 : Form
    {
        ...
        private void buttDashboard_Click(object sender, EventArgs e)
        {
        ...
        private void butFormateur_Click(object sender, EventArgs e)
        {

        }

        private void butSecrétaire_Click(object sender, EventArgs e)
        {

        }

        private void butApprenants_Click(object sender, EventArgs e)
        {

        }

        private void butParamètres_Click(object sender, EventArgs e)
        {
